/*
  ...
  - The values [SURVEY,CURRICULUM,PROFILE,COMPLETED] on the enum `OnboardingStep` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "OnboardingStep_new" AS ENUM ('CAREER_PATH', 'INTERESTS', 'EXPERIENCE', 'GOALS', 'SCHEDULE', 'BACKGROUND', 'PORTFOLIO', 'MENTORSHIP', 'RECOMMENDATIONS');
